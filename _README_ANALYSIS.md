...
1. **`QUICK_REFERENCE.md`** ⭐ Start here - 2 minute quick guide
...
1. **`calculations.correct.test.ts`** - ✅ All passing (6/6)
2. **`persistence.diagnostic.test.ts`** - ✅ All passing (4/4)
...
2. 🔍 Run the disable-sync test (2 min)
3. 📊 Check localStorage in DevTools (1 min)
